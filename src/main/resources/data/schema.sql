...
CREATE TEXT TABLE IF NOT EXISTS HSQLDB_EBEDDED.KUNDE (ID_Kunde INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,Anrede VARCHAR(16), Nachname VARCHAR(32), Strasse VARCHAR(32), Ort VARCHAR(32), PLZ VARCHAR(8));
CREATE TEXT TABLE IF NOT EXISTS HSQLDB_EBEDDED.KUNDE_NOTIZ (ID_Kunde INTEGER PRIMARY KEY, Notiz VARCHAR(2048));
CREATE TEXT TABLE IF NOT EXISTS HSQLDB_EBEDDED.KARTE (ID_Karte INTEGER, ID_Kunde INTEGER, Kartentyp INTEGER, Jahr INTEGER);
CREATE TEXT TABLE IF NOT EXISTS HSQLDB_EBEDDED.KARTE_TYP (ID_Kartentyp INTEGER, Kartentyp_Bezeichnug VARCHAR(32));
CREATE TEXT TABLE IF NOT EXISTS HSQLDB_EBEDDED.AUFTRAG (ID_Auftrag INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, ID_Kunde INTEGER, Datum DATE, Nr INTEGER, Betrag FLOAT);
